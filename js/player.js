$(function () {
    ...
    var musicImgsData = ['img/img-selection/1huoyuanjia.jpg', 'img/grorup-gril.jpg', 'img/img-selection/YouEye3.jpg']    // 图片地址数组
    var musicNameData = ['霍元甲', 'Never Say Die', '你是我的眼'];                   // 歌曲名数组
    var artistNameData = ['周杰伦', '黑豹乐队', '萧煌奇']            // 创作歌手数组
    var musicUrls = ['audio/zjl-霍元甲.mp3', 'audio/CHVRCHES - Never Say Die.mp3', 'audio/你是我的眼-.mp3'];// 歌曲mp3数组
